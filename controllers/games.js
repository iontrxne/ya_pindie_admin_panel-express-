...
//Отправляем все игры
const sendAllGamesController = async (req, res) => {
  res.send(req.games);
}
...
//Добавляем игру в файл games.json
...
module.exports = { sendAllGamesController, deleteGameController, addGameController }